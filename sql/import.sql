...
COPY kato_katz(cid,cin,date,Sm_A,Sm_B,Hw_A,As_A,As_B,Other,weeks_tx,other_helminth) FROM '/Users/tristanpwdennis/Projects/Schisto/SCHISTO_DB/data/kk_data.csv' DELIMITER ',' CSV HEADER;